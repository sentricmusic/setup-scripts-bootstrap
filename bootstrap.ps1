...
function Main {
    ...
    Write-Host "    $sentricPath" -ForegroundColor Cyan
     Write-Host ""
     Write-Host "  Run this command to complete setup:" -ForegroundColor White
     Write-Host ""
     Write-Host "    cd `"$workspacePath`"; .\setup.ps1" -ForegroundColor Yellow
    Write-Host ""
    Write-Host "  Or with options:" -ForegroundColor Gray
    Write-Host "    .\setup.ps1 -Interactive    # Interactive mode" -ForegroundColor Gray
    Write-Host "    .\setup.ps1 -Step 4         # Skip to step 4" -ForegroundColor Gray
    Write-Host "    .\setup.ps1 -Help           # Show all options" -ForegroundColor Gray
    Write-Host ""
}
